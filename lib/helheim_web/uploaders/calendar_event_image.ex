defmodule HelheimWeb.CalendarEventImage do
  ...
  def transform(:large, _) do
    {:convert, "#{@magick_limits} -strip -resize 800x800^ -gravity center"}
  end
  ...
  def transform(:tiny, _) do
    {:convert, "#{@magick_limits} -strip -thumbnail 55x55^ -gravity center -extent 50x50"}
  end
