...
Please **do not** use the issue tracker for personal support requests nor feature requests. Support requests should be sent to an [admin or moderator](https://helheim.dk/staff) on the site.

Development issues can be discussed on [the forum](https://helheim.dk/forums/60).
...
Feature requests are welcome and should be discussed on [the forum](https://helheim.dk/forums/1). But take a moment to find
...
Documentation is currently in a scarce state since open sourcing the project. Any help with getting more complete documentation is greatly appreciated!
...
```elixir
@doc """
Returns true if the specified user has ever donated to Helheim, otherwise returns false.
"""
...
```elixir
defmodule Helheim.Donations do
  @moduledoc """
  Conveniences for working with user donations.
  ...
  """
```
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/helheim
   # Navigate to the newly cloned directory
   cd helheim
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/dipth/helheim
   ```
